...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('/')}}" class="logo">
            ...
            <span class="logo-lg"><b>SHAA3At</b></span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left image">
                    <img src="{{ asset('storage/images/avatars/'.Auth::user()->avatar) }}" class="img-circle"
                         alt="User Image">
                </div>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="http://iti.gov.eg/Site/AlexBranch" target="_blank">ITI</a>.</strong> All
        rights
        reserved.
    </footer>
...
<script src="{{ asset('bower_components/fastclick/lib/fastclick.js') }}
        "></script>
<!-- AdminLTE App -->
<script src="{{ asset('bower_components/admin-lte/dist/js/adminlte.min.js') }}
        "></script>
<!-- Sparkline -->
<script src="{{ asset('bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}
        "></script>
<!-- jvectormap  -->
<script src="{{ asset('bower_components/admin-lte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}
        "></script>
